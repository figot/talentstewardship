...
$this->title = Yii::t('common', 'Scenic');
                ...
                GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'format' => 'raw',
                            'value' => function($model){
                                return Html::a('生成景区签入二维码',['scenic/qrcode', 'id' => $model->id], ['class' => "btn btn-xs btn-info", 'target'=> '_blank']);
                            }
                        ],
//                        [
//                            'attribute'=>'orders',
...
//                            'format' => 'raw',
//                            'value' => function($model){
//                                return Html::a('景区订单',['scenicorder/index', 'scenicid' => $model->id], ['class' => "btn btn-xs btn-info"]);
//                            }
//                        ],
                        [
                            'attribute' => 'status',

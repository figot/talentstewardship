...
$this->title = Yii::t('common', 'Welfare');
            ...
            <div class="adv-table editable-table ">
                ...
                GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            'attribute'=>'welfareapply',
                            'label' => '待遇申请',
                            'format' => 'raw',
                            'value' => function($model){
                                return Html::a('申请汇总详情',['welfareapply/index', 'id' => $model->id], ['class' => "btn btn-xs btn-info"]);
                            }
                        ],
                        [
                            ...
                            'format' => 'raw',
                            'value' => function($model){
                                return Html::a('上传材料模板',['welfaretemplate/index', 'treatid' => $model->id], ['class' => "btn btn-xs btn-info"]);
                            }
                        ],
                        [

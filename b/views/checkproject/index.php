                ...
                GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'format' => 'raw',
                            'value' => function($model){
                                return Html::a('项目申报申请列表',['checkprojectapply/index', 'projectid' => $model->id], ['class' => "btn btn-xs btn-info"]);
                            }
                        ],
                        [
                            'attribute'=>'checkprojectapply',
                            'label' => '市委考核申请',
                            'format' => 'raw',
                            'value' => function($model){
                                return Html::a('市委考核申请',['checkprojectapply/create', 'projectid' => $model->id], ['class' => "btn btn-xs btn-info"]);
                            }
                        ],
                        [
                            'attribute' => 'status',

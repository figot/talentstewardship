                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'value' => function($model){
                                return Html::a('上传材料模板',['talentfiles/index', 'talentcategoryid' => $model->id], ['class' => "btn btn-xs btn-info"]);
                            }
                        ],
                        [
                            'attribute'=>'templatefile',
                            ...
                            'format' => 'raw',
                            'value' => function($model){
                                return Html::a('人才认证申请列表',['talentapply/index', 'talentcategoryid' => $model->id], ['class' => "btn btn-xs btn-info"]);
                            }
                        ],
                        [
                            'attribute' => 'status',

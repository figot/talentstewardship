                ...
                <header class="panel-heading">
                    <div class="clearfix">
                        <div class="btn-group">
                            <?
                            if ($model->status == 2) {
                                echo Html::a('确认离店，打印用户离店确认单'.' <i class="fa fa-plus"></i>', ['report', 'id' => $model->id, 'status' => 3], ['class' => 'btn btn-success', 'style' => 'margin-bottom:15px;margin-left:60px;', 'target'=> '_blank']);
                            } else {
                                echo Html::a('用户目前不在酒店入住状态，请先确认入住再打印离店确认单'.' <i class="fa fa-plus"></i>', ['checkout', 'id' => $model->id], ['class' => 'btn btn-success', 'disabled' => true, 'style' => 'margin-bottom:15px;margin-left:60px;', 'target'=> '_blank']);
                            } ?>
                        </div>
                    </div>
                </header>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-offset-1 col-lg-11">
                            ...
                            <br/>
                            <br/>
                            <h4 class="text-center"> 本人签字</h4>
                            <h4 class="text-center"> &nbsp;&nbsp;&nbsp;&nbsp;年&nbsp;&nbsp;&nbsp;&nbsp;月&nbsp;&nbsp;&nbsp;&nbsp;日</h4>
                            <br/>
                        </div>
                    </div>
                    <div class="row">

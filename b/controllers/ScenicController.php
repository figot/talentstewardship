...
use b\models\Scenic;
use b\models\Area;
use b\models\search\ScenicSearch;
...
class ScenicController extends Controller
{
    ...
    protected function findModel($id)
    {
        ...
        if (($model = Scenic::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    public function actionQrcode($id)
    {
        ...
        $url = \Yii::$app->request->getHostInfo() . '/app/web/qrcode/sceniccheckin?pid=' . $id . '&access_token=';

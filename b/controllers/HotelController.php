...
class HotelController extends Controller
{
    ...
    public function actionImages($id)
    {
        ...
        if ($model->load(Yii::$app->getRequest()->post())) {
            ...
            return $this->render('images', ['model' => $model,'searchModel' => $searchModel, 'dataProvider' => $dataProvider,]);
        }
    }
    /**
     * @inheritdoc
    ...
    {
        $model = $this->findHotelImgs($id);
        $hotelid = $model->hotelid;

        $model->delete();
        return $this->redirect(['images', 'id' => $hotelid]);
    }
    /**
     * @inheritdoc
     */
    ...
    protected function findHotelImgs($id)
    {
        ...
        if (($model = Hotelimages::findOne($id)) !== null) {
            return $model;
        } else {
            throw new NotFoundHttpException('The requested page does not exist.');
        }

...
use b\models\Demandinfo;
use b\models\search\DemandinfoSearch;
 ...
 * 供需信息
 */
class DemandinfoController extends Controller
{
    ...
    {
        $searchModel = new DemandinfoSearch();
    ...
    protected function findModel($id)
    {
        ...
        if (($model = Demandinfo::findOne($id)) !== null) {
            return $model;
        } else {

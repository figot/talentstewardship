...
class BaseHtmlPurifier
{
    ...
    public static function process($content, $config = null)
    {
        ...
        $htmlDef = $purifier->config->getHTMLDefinition(true);
        $paragraph = $htmlDef->addBlankElement("img");
        $paragraph->attr_transform_post[] = new \HTMLPurifier_AttrTransform_ImgWidth();

//        $htmlDef = $purifier->config->getHTMLDefinition(true);
//        $paragraph = $htmlDef->addBlankElement("p");
//        $paragraph->attr_transform_post[] = new \HTMLPurifier_AttrTransform_SpanAttr();

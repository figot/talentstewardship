...
class AdminModel extends BaseModel implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            [['password'], 'string', 'min' => 6, 'on' => ['create', 'update', 'registration']],
            [['passwordrepeat'], 'compare', 'compareAttribute' => 'password', 'message' => '两次密码不一致', 'on' => ['registration']],

            ['status', 'default', 'value' => self::STATUS_ACTIVE],
            ['status', 'in', 'range' => [self::STATUS_ACTIVE, self::STATUS_DELETED, self::STATUS_CHECKING]],
        ];
    }
